...
import {
  Visibility, VisibilityOff, Business, PersonAdd as RegisterIcon,
  Email, Lock, ArrowForward, Dashboard, Add, Edit, Analytics,
  People, Schedule, AttachMoney, Star, Settings, Person
...
const RegisterPage = () => {
  ...
  return (
    ...
    >
      ...
      <Container maxWidth="xl" sx={{ flex: 1, display: 'flex', alignItems: 'center', py: 2 }}>
        <Box
          sx={{
            display: 'flex',
          ...
          >
            <Fade in={true} timeout={800}>
              <Box sx={{ textAlign: 'center', position: 'relative', zIndex: 2 }}>
                ...
                >
                  Complete control over your gaming cafe business
                </Typography>
      ...
      <Box
        sx={{
          ...
          alignItems: 'center',
                    ...
                    >
                      Register as a cafe owner to get started
            </Typography>
                  </Box>
